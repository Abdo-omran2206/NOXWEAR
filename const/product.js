const Products = [
  {
    ...
    sizes: ["L", "XL"],
    colors: [
      { name: "Cyber Purple", code: "#a855f7" },
      { name: "Matte Black", code: "#0f0f11" },
      { name: "Volt Green", code: "#00ffb2" },
    ],
  },

  {
    ...
    sizes: ["M", "L", "XL"],
    colors: [
      { name: "Slate Gray", code: "#4b5563" },
      { name: "Carbon Black", code: "#1a1a1a" },
      { name: "Ash White", code: "#e5e7eb" },
    ],
  },

  {
    ...
    sizes: ["M", "L"],
    colors: [
      { name: "Midnight Navy", code: "#1e1b4b" },
      { name: "Matte Black", code: "#0f0f11" },
      { name: "Cobalt Blue", code: "#1d4ed8" },
    ],
  },
...

  {
    ...
    sizes: ["M", "L", "XL"],
    colors: [
      { name: "Desert Tan", code: "#d6d3d1" },
      { name: "Matte Black", code: "#0f0f11" },
      { name: "Olive Drab", code: "#3f4931" },
    ],
  },

  {
    ...
    sizes: ["M", "L", "XL"],
    colors: [
      { name: "Gunmetal Gray", code: "#374151" },
      { name: "Matte Black", code: "#0f0f11" },
      { name: "Electric Orange", code: "#f97316" },
    ],
  },

  {
    ...
    sizes: ["M", "L", "XL"],
    colors: [
      { name: "Stealth Black", code: "#08080a" },
      { name: "Ranger Green", code: "#166534" },
      { name: "Cement Gray", code: "#6b7280" },
    ],
  },
];